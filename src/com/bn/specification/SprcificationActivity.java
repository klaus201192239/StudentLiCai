...
import com.bn.financial_assistant.AccountItemActivity;
import com.bn.financial_assistant.JianYiFeedbackActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SpList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position == 2) {
					Intent intent = new Intent();
					intent.setClass(SprcificationActivity.this,JianYiFeedbackActivity.class);
