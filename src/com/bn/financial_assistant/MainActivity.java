...
public class MainActivity extends Activity {
	...
	private Button bn_job;
	private Button bn_settings;
	private Button bn_tongji;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bn_job = (Button) this
				.findViewById(R.id.layout_main_bn_job);
		bn_job.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(MainActivity.this, JobActivity.class);
				startActivity(intent);
				overridePendingTransition(R.anim.add_go, R.anim.main_go);
				MainActivity.this.finish();
			}
		...
		bn_settings = (Button) this
				.findViewById(R.id.layout_main_bn_settings);
		bn_settings.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(MainActivity.this, SeettsActivity.class);
				startActivity(intent);
				overridePendingTransition(R.anim.add_go, R.anim.main_go);
				//MainActivity.this.finish();
			}
		...
		bn_tongji = (Button) this
				.findViewById(R.id.layout_main_bn_tongjii);
		bn_tongji.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
